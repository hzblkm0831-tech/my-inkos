...
async function createBookDir(prefix) {
...
async function writeChapter(bookDir, chapter, title, body) {
    const filename = `${String(chapter).padStart(4, "0")}_${title}.md`;
    await writeFile(join(bookDir, "chapters", filename), `# 第${chapter}章 ${title}\n\n${body}\n`, "utf-8");
}
...
//# sourceMappingURL=long-span-fatigue.test.js.map