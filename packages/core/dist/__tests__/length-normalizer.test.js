...
function createAgent() {
    return new LengthNormalizerAgent(AGENT_CONTEXT);
}
describe("LengthNormalizerAgent", () => {
    ...
    it("compresses a long draft while preserving required markers", async () => {
        ...
        const chatSpy = vi.spyOn(BaseAgent.prototype, "chat").mockResolvedValue({
...
//# sourceMappingURL=length-normalizer.test.js.map