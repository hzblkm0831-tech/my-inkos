...
import { CADENCE_PRESSURE_THRESHOLDS, CADENCE_WINDOW_DEFAULTS, LONG_SPAN_FATIGUE_THRESHOLDS, resolveCadencePressure, } from "../utils/cadence-policy.js";
describe("cadence-policy", () => {
    it("exposes shared cadence and fatigue defaults from one policy surface", () => {
        ...
        expect(CADENCE_WINDOW_DEFAULTS.englishVarianceLookback).toBeGreaterThan(CADENCE_WINDOW_DEFAULTS.summaryLookback);
...
//# sourceMappingURL=cadence-policy.test.js.map