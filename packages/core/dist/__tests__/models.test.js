...
import { ProjectConfigSchema, LLMConfigSchema, NotifyChannelSchema, InputGovernanceModeSchema, } from "../models/project.js";
import { ChapterIntentSchema, ContextPackageSchema, RuleStackSchema, ChapterTraceSchema, } from "../models/input-governance.js";
...
describe("InputGovernanceModeSchema", () => {
    it.each(["legacy", "v2"])("accepts '%s'", (value) => {
