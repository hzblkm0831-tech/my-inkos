...
import { parseWriterOutput, parseCreativeOutput } from "../agents/writer-parser.js";
...
function callParseOutput(chapterNumber, content, genreProfile = defaultGenreProfile, countingMode = "zh_chars") {
