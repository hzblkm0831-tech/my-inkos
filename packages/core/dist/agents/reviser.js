...
export const DEFAULT_REVISE_MODE = "spot-fix";
...
${chapterContent}`;
    ...
    parseOutput(content, gp, mode, originalChapter) {
        const extract = (tag) => {
