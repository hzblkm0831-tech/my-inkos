 ...
 */
export function buildObserverSystemPrompt(book, genreProfile, language) {
...
export function buildObserverUserPrompt(chapterNumber, title, content, language) {
    const isEnglish = language === "en";
    return isEnglish
        ? `Extract all facts from Chapter ${chapterNumber} "${title}":\n\n${content}`
        : `请提取第${chapterNumber}章「${title}」中的所有事实：\n\n${content}`;
}
//# sourceMappingURL=observer-prompts.js.map