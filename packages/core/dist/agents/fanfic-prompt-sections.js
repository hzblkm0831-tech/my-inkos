...
export function buildFanficCanonSection(fanficCanon, mode) {
    return `
## 同人正典参照
...
export function buildCharacterVoiceProfiles(fanficCanon) {
    // Extract character table from fanfic_canon.md
    const tableMatch = fanficCanon.match(/## 角色档案[\s\S]*?\n(\|[^\n]+\|\n\|[-|\s]+\|\n(?:\|[^\n]+\|\n)*)/);
    if (!tableMatch)
        return "";
...
export function buildFanficModeInstructions(mode, allowedDeviations) {
...
//# sourceMappingURL=fanfic-prompt-sections.js.map