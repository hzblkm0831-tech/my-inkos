...
export function buildEnglishCoreRules(_book) {
...
export function buildEnglishAntiAIRules() {
...
export function buildEnglishCharacterMethod() {
...
export function buildEnglishPreWriteChecklist(book, gp) {
    const items = [
